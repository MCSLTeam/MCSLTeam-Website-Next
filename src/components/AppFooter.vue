    ...
    <div class="footer-content">
      ...
      <div class="footer-right">
        ...
        <div class="contact-links">
          ...
          <a target="_blank" href="https://afdian.com/a/lxhtt" class="contact-link">
            <n-icon size="20" class="contact-icon">
                <div v-html="afdianSvg"></div>
            </n-icon>
          </a>
          <a target="_blank" href="https://jq.qq.com/?_wv=1027&k=x2ISlviQ" class="contact-link">
            <n-icon size="24" class="contact-icon">
                <div v-html="qqSvg"></div>
            </n-icon>
          </a>
...
:deep(.n-theme-dark) .footer-left p {
...
:deep(.n-theme-dark) .beian-link {
  color: rgba(44, 44, 44, 0.7);
}

:deep(.n-theme-dark) .beian-link:hover {
  color: #19e8a2;
}
...
:deep(.n-theme-dark) .contact-link {
  color: rgba(44, 44, 44, 0.7);
}

:deep(.n-theme-dark) .contact-link:hover {
  color: #19e8a2;
  background-color: rgba(25, 232, 162, 0.1);
}
